...
public class TS_010_Tc_069toTc70_ERO_Mass_Cost_Update extends Keywords{
	public void Scenario010(WebDriver driver, ExtentTest test,ExtentTest test1,String url, int dataset) throws AWTException, IOException, InterruptedException {	
...
click(driver, Cancel_Button);
	...
	Extent_cal(test, "Testcase 69 - Ensure Scientific grid allows Filter functionality according to the conditions and inputs (Ascending)");
	wait(driver,"3");
	...
	Extent_cal(test, "Filter functionality1");
		...
		String locationname = getText(driver, Grid_Rec1);
		...
		String locationname2 = getText(driver, Grid_Rec1);
