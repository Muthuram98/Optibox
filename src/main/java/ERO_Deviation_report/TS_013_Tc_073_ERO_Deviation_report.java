...
public class TS_013_Tc_073_ERO_Deviation_report extends Keywords {
	public void Scenario013(WebDriver driver, ExtentTest test, ExtentTest test1, String url, int dataset)
			throws AWTException, IOException, InterruptedException {

		System.out.println("url : " + url);

		String Username = Utils.getDataFromTestData("TS_013_Tc_073_ERO_Dataset"+dataset, "ERO_Deviation_report", "Username");
		String Password = Utils.getDataFromTestData("TS_013_Tc_073_ERO_Dataset"+dataset, "ERO_Deviation_report", "Password");
		String ID = Utils.getDataFromTestData("TS_013_Tc_073_ERO_Dataset"+dataset, "ERO_Deviation_report", "Id");
		String ID2 = Utils.getDataFromTestData("TS_013_Tc_073_ERO_Dataset"+dataset, "ERO_Deviation_report", "ID_2");
		String EQ_Type = Utils.getDataFromTestData("TS_013_Tc_073_ERO_Dataset"+dataset, "ERO_Deviation_report", "EQU_Type");
		...
		click(driver, Cancel_Report);
				...
				Extent_cal(test, "Testcase 73 - Ensure Easy search option working properly");
