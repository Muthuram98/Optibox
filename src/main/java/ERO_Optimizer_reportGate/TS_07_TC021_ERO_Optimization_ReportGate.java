...
public class TS_07_TC021_ERO_Optimization_ReportGate extends Keywords{
	
	public void Scenario7(WebDriver driver, ExtentTest test, ExtentTest test1, String url, int dataset) throws AWTException, IOException {
		
		System.out.println("url : " + url);
		String Username = Utils.getDataFromTestData("TS_07_TC021_ERO_Optimization_ReportGate_Dataset"+dataset, "ReportGate","Username");
		String Password = Utils.getDataFromTestData("TS_07_TC021_ERO_Optimization_ReportGate_Dataset"+dataset, "ReportGate","Password");
    	String Error_Msg_popup_Location1 = Utils.getDataFromTestData("TS_07_TC021_ERO_Optimization_ReportGate_Dataset"+dataset, "ReportGate", "Error_Msg_popup_Location");
		...
		Extent_cal(test,
				"Testcase 21 - Verify that system is allowing to display the validation msg  while trying to add a load location without entering a ID");
